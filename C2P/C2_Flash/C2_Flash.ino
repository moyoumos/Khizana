...
//{
//	//
//	if ((DeviceID == C8051F32X_DEVICEID)  || (DeviceID == EFM8LB12_DEVICEID))
//		C2ADD_FPDAT = 0xB4;
//	else
//		C2ADD_FPDAT = 0xAD;
//}
